    ...
    elseif($_POST['action']=="password")
    {
        ...
        else
        {
            ...
            if(count($Results)>=1)
            {
                ...
                $from = 'bd@mastercards.co';
                $body='Hi, <br/> <br/>Your Membership ID is '.$Results['id'].' <br><br>Click here to reset your password http://www.mastercards.co/fpass1/reset.php?encrypt='.$encrypt.'&action=reset   <br/> <br/>--<br>www.mastercards.co<br>Solve your problems.';
