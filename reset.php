...
{          
    if($_GET['action']=="reset")
    {
        ...
        {
            $message = 'Invalid key please try again. <a href="http://www.mastercards.co/fpass1/index.php#forget">Forget Password?</a>';
        }
    }
}
...
//        echo $query;
        $message = "Your password changed sucessfully <a href=\"http://www.mastercards.co/fpass1/\">click here to login</a>.";
    }
    else
    {
        $message = 'Invalid key please try again. <a href="http://www.mastercards.co/fpass1/#forget">Forget Password?</a>';
    }
}
else
{
